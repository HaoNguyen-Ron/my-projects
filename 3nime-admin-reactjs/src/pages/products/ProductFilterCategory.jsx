...
export default function ProductFilterCategory({ setQueryResult, productsList }) {
  ...
  useEffect(() => {
    ...
    if (selectedCategory.length === 0) {
      ...
      const resultArray = productsList.filter((product) => selectedCategory.includes(product.category.name));
      setQueryResult(resultArray);
    }
  }, [selectedCategory, productsList, setQueryResult]);
