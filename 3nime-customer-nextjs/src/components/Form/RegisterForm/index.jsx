...
const RegisterForm = () => {
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      birtday: Yup.date("Ngày sinh theo định dạng YYYY/MM/DD nha!"),
      // .required('Ngày tháng năm sinh bắt buộc nhập nha!'),

      city: Yup.string().required("Thành phố / Tỉnh bắt buộc nhập nha!"),

      district: Yup.string().required("Quận / Huyện bắt buộc nhập nha!"),

      ward: Yup.string().required("Phường / Xã bắt buộc nhập nha!"),

      street: Yup.string().required("Địa chỉ bắt buộc nhập nha!"),
      ...
      password: Yup.string()
        ...
        .matches(
          ...
          "Mật khẩu bắt buộc phải có ít nhất 1 chữ cái in hoa và 1 chữ số"
        )
  ...
  return (
    <div className={`px-5 mx-auto my-5 ${styles.formContainer}`}>
      ...
      <div className="d-flex flex-column">
        ...
        <div className="mb-4">
          <InputAddress validation={validation} classNamees="valid" />
        </div>
          ...
          <div className="d-flex flex-column">
            ...
            <div className="mt-4">
              <button
                ...
                onClick={handleClose}
              >
                <Link className={styles.modal__link} href={"/"}>
                  Đến trang đăng nhập
                </Link>
              </button>
            </div>
      ...
      >
        <Box sx={style}>
          <div className="d-flex flex-column">
            ...
            <hr />
            <Typography id="modal-modal-description">
              Đã có tài khoản khác trùng với thông tin số điện thoại hay email
              đang sử dụng để đăng ký, bạn vui lòng chọn thông tin khác nha !
            </Typography>
